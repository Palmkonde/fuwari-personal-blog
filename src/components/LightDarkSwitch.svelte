...
// ponytail: no props, but calling $props() keeps the generated type from being
// Record<string, never>, which rejects Astro's client:only directive at the call site
